...
// base-nova Badge (pill), reproduced from the admin-frontend design system verbatim
// (FM5). Uses Base UI useRender/mergeProps so it can render as any tag via `render`.
