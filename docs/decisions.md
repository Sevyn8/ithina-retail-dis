...
**Status.** Resident/test Pub/Sub isolation `IMPLEMENTED`; post-suite clean-state guard re-enablement `DEFERRED` (test-infra only; no migration/schema/service change).
